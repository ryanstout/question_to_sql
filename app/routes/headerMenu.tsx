import {
    Anchor, Box,
    Burger, Button, Center, Collapse, createStyles, Divider, Drawer, Flex, Group, Header,
...
import {
    IconBook,
    IconChartPie3, IconChevronDown, IconCode, IconCoin, IconFingerprint, IconNotification
} from '@tabler/icons';
